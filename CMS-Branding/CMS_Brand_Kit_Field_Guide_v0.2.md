# Cloud Mind Social | Brand Guidelines v0.2
...
These guidelines help every person representing Cloud Mind Social communicate with the same clarity, care, and strategic intent. They explain how to use our identity across social media, presentations, proposals, reports, and other brand materials.

Our brand should make a business owner feel understood and help them see what deserves attention. Every design and message should support that purpose through clear reasoning, readable information, and visible human accountability.

### About the brand

Cloud Mind Social is a social media marketing agency built around Strategic Social Intelligence. We bring together a flexible network of specialists, directed by strategy and delivered through human partnership. We begin by understanding the business before recommending the depth of support it needs.

**Cloud** is our specialist infrastructure. **Mind** is the thinking that directs the work. **Social** is the execution and relationship that turn that thinking into a credible presence.
...
Use an authentic founder or specialist photograph, ideally showing a real conversation or working session. No suitable team photos were found in the reviewed brand folders; add an authorized CMS photo here when available. Do not substitute a stock team and present it as CMS.
...
**Image upload:** `logo-horizontal-standard.png`
...
**Image upload:** `logo-variations.png`
...
| Primary color* | Role |
| --- | --- |
| Warm ink · #1C1B1A | The main information color: headlines, body copy, diagnostic statements, and strong contrast. |
| Warm cream · #F7F2EA | The shared base: calm backgrounds that make the information easy to read. |
| Clay coral · #D6553A | The signature Social accent: relationship touchpoints and selective emphasis. Keep small essential text off coral fills. |

### Our secondary colors

| Secondary color* | Role |
| --- | --- |
| Mist slate · #AEB8B4 | Supporting panels, dividers, and purposeful network graphics. Use sparingly. |
| Deep ochre · #C98A2E | A second Social accent for controlled variation. Ink text on ochre is a useful readable pairing. |

*The five hex values and semantic roles are established. This primary/secondary grouping is a proposed organizational mapping for Canva’s fields; it does not replace the existing Cloud/Mind/Social meaning system.

### Usage balance

Let cream form the main surface and ink carry the information. Add slate only where structure benefits. Choose coral or ochre as the main accent within a composition. Every asset does not need all five colors.

Do not add navy from the logo files to the content palette without a specific brand decision. The extra #8A8981 label gray appearing in the older handoff remains unresolved and is not included here as a sixth palette color.
...
| --- | --- | --- |
| Ink on cream | 15.43:1 | Default for essential text and long explanations. |
| Cream on ink | 15.43:1 | High-contrast title blocks or small CTA labels. |
| Ink on slate | 8.45:1 | Supporting information panels. |
| Ink on ochre | 5.86:1 | Readable accent panels. |
| Ink on coral | 4.27:1 | Large text only; below 4.5:1. |
| Cream on coral | 3.61:1 | Large text only; avoid small CTA labels. |
| Cream on ochre | 2.63:1 | Avoid for essential text. |
| Slate on cream | 1.83:1 | Decoration only; avoid essential text. |

### Readability target

Use at least 4.5:1 for ordinary text and 3:1 for large text. The W3C large-text definition is at least 18 pt regular or 14 pt bold at the viewed size. For social graphics that shrink on screen, use 4.5:1 for essential text as the safer default. Ratios are calculated from the exact palette values; displayed values are rounded. [S4]

### Applying color accessibly

Use labels, symbols, or patterns alongside color when showing categories or status. Place text on a quiet solid surface. Keep source notes readable. Underline links where the environment supports it. Recheck contrast whenever opacity, imagery, or background colors change.

**Proposed reference correction:** use cream text on ink for small CTAs, with coral nearby as an accent. This preserves the palette while addressing the existing cream-on-coral contrast issue.
...
| --- | --- | --- |
| Heading | Fraunces | 500 Medium or 600 Semibold; regular and italic. |
| Body | Inter | 400 Regular for explanation; 500 Medium for emphasis and subtitles. |
| Labels | Space Mono | 400 Regular or 700 Bold; short uppercase labels with restrained tracking. |
...
| Level | Proposed starting point |
| --- | --- |
| Document title | Fraunces 600; 32–40 pt. |
| Section heading | Fraunces 500 or 600; 24–30 pt. |
| Subtitle / subheading | Inter 500; 14–18 pt. |
| Body copy | Inter 400; 11–12 pt, about 1.35–1.5 line spacing. |
| Short labels | Space Mono 400/700; 9–10 pt when readable at the actual size. |

Use left alignment for sustained reading. Keep emphasis selective. Recompose and enlarge type for social graphics instead of shrinking a document page. Do not add Inter 600 by default; its isolated appearance in the reference handoff remains a decision to resolve.
...
Cloud Mind Social speaks as a confident, authoritative, direct, and empathetic partner. We name the business situation clearly, explain our reasoning, and recommend the depth of support that is justified. We communicate as a coordinated agency while keeping the people responsible for the work visible.

| Voice trait | What it means |
| --- | --- |
| Confident | Make a clear recommendation and explain the basis for it. |
| Authoritative | Support statements with process, relevant evidence, or a clear reason. |
| Direct | Use plain sentences, concrete language, and a clear next step. |
| Empathetic | Recognize the owner’s pressure without shaming them or making assumptions. |
...
**Image upload:** `graphics-and-icons.png`
...
**Image upload:** `chart-examples.png`
...
Digital applications; Facebook and LinkedIn

**Image upload:** `mockup-facebook.png`

Facebook account concept; illustrative layout, not a screenshot of a live CMS account.

**Image upload:** `mockup-linkedin.png`

LinkedIn account concept; illustrative layout, not a screenshot of a live CMS account.

Use a clear brand name, a legible profile mark, and a cover that communicates the core idea. Facebook should feel approachable and useful; LinkedIn should foreground clear business thinking and credible explanations. These mockups demonstrate identity application, not approved profile copy or final platform strategy.
...
Digital applications; Instagram and Threads

**Image upload:** `mockup-instagram.png`

Instagram account concept; sample grid titles show hierarchy, not approved posts.

**Image upload:** `mockup-threads.png`

Threads account concept; wording is illustrative and does not represent published content.

Instagram should make the visual system recognizable across a sequence. Threads should retain the voice in a simpler, text-led environment. Keep the same name, descriptor, palette, and profile treatment. Do not invent follower counts, testimonials, badges, or performance data.
...
Digital applications; YouTube and TikTok

**Image upload:** `mockup-youtube.png`

YouTube channel concept; headings and thumbnails are illustrative teaching themes.

**Image upload:** `mockup-tiktok.png`

TikTok account concept; sample cover cards demonstrate brand application only.

YouTube should make the teaching structure clear. TikTok should make the people and thinking accessible at a glance. Recompose covers for the platform; do not shrink a document page. The mockups use schematic interface frames, not exact platform UI specifications. Verify live safe areas and dimensions when production begins.


## 17. Implementation notes

**EDITOR NOTES / REVIEW STATUS**

For the Brand Kit editor; not public-facing copy

Copy each field’s text into Canva’s Brand Guidelines and upload its named image. This packet follows Seul’s requested field structure; it does not populate the native Brand Kit.

| Item | Decision or status |
| --- | --- |
| Existing foundation | Preserved from the reviewed README and Branding.md. |
| Creative direction | Structured strategy practice, expressed through editorial design; approved by Seul. |
...
- [Logo System Reference](https://github.com/seulyekha/cloud-mind-social/blob/main/CMS-Branding/CMS-Logo-System-Reference.pdf)
- [W3C: Contrast (Minimum)](https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html)

S1: README and Branding.md; internal source of truth. S2: Color and Typography Reference; established palette and fonts. S3: Logo System Reference; draft catalog and quality findings. S4: W3C Contrast (Minimum); high confidence, official standards guidance. Graphic, icon, chart-selection, and mockup rules are proposed application guidance.

Version 0.2; September 15, 2026. This packet supersedes v0.1 for Brand Kit field structure and adds the previously omitted logo assets. It does not override locked decisions or authorize website work.
